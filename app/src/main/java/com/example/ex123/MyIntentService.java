...
public class MyIntentService extends IntentService {
    ...
    protected void onHandleIntent(@Nullable Intent intent) {
        ...
        nBuilder.setContentText("hello");
        nBuilder.setSmallIcon(R.drawable.birdicon);

        //what to do when the notification is clicked
        Intent intent1= new Intent(this,MainPageActivity.class);
        PendingIntent pendingIntent = PendingIntent.getActivity(this, REQUEST_CODE, intent1, PendingIntent.FLAG_CANCEL_CURRENT);
